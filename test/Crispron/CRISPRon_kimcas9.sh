#!/bin/bash
CRISPRon_dir='/home/kwlee/Projects_gflas/DACO2/tools/crispron'
BINDIR='/home/kwlee/Projects_gflas/DACO2/tools/crispron/bin'
DATADIR='/home/kwlee/Projects_gflas/DACO2/tools/crispron/data'

INDIR='/home/kwlee/Projects_gflas/DACO2/data/input/Raw_data/Kim-Cas9'
OUTDIR='/home/kwlee/Projects_gflas/DACO2/output/Crispron/Kim-Cas9'
...
if [[ ! -s $INDIR/30mers.fa ]]; then
	python3 ./readfile.py --data Kim-Cas9
fi
