...
#python3 ./main.py --model 0 --target 8 --embd 0 --seqinfo ${j}

	echo -e "Log: Cas12a/embdtb/seq_${j}\n"
	echo -e "python3 ./main.py --model 0 --target 8 --embd 1 --seqinfo ${j}\n"
#python3 ./main.py --model 0 --target 8 --embd 1 --seqinfo ${j}
...
#python3 ./main.py --model 0 --target 8 --embd 2 --seqinfo ${j} --kmer ${k} --stride ${s}
		done
	done
done
